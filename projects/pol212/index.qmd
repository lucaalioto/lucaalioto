...
#read in data
election = read_csv(here("projects/pol212/data/countypres_2000-2020.csv"))
gdp = read_csv(here("projects/pol212/data/CAGDP1__ALL_AREAS_2001_2023.csv"))
gallup = readRDS(here("projects/pol212/data/combined2_proj.rds"))
```
...
knitr::include_graphics(here("projects/pol212/figures/dag.png"))
```
...
knitr::include_graphics(here("projects/pol212/figures/table1.png"))
```
...
```{r, echo=FALSE, out.width="70%", fig.align = 'center'}
knitr::include_graphics(here("projects/pol212/figures/table2.png"))
```
