...
subtitle: "POL 212: Final Project | Winter 25"
author: "Luca Alioto"
---
...
#read in data
election = read_csv(here("project_data/pol212/01_data/countypres_2000-2020.csv"))
gdp = read_csv(here("project_data/pol212/01_data/CAGDP1__ALL_AREAS_2001_2023.csv"))
gallup = readRDS(here("project_data/pol212/01_data/combined2_proj.rds"))
```
...
Despite concerns around a challenging of the norms and democratic stability, Trump’s support has remained strong, raising the question:
...
knitr::include_graphics(here("project_data/pol212/03_figures/dag.png"))
```
...
knitr::include_graphics(here("project_data/pol212/03_figures/table1.png"))
```
...
```{r, echo=FALSE, out.width="70%", fig.align = 'center'}
knitr::include_graphics(here("project_data/pol212/03_figures/table2.png"))
```
