...
#read in data
election = read_csv(here("data/pol212/01_data/countypres_2000-2020.csv"))
gdp = read_csv(here("data/pol212/01_data/CAGDP1__ALL_AREAS_2001_2023.csv"))
gallup = readRDS(here("data/pol212/01_data/combined2_proj.rds"))
```
...
knitr::include_graphics(here("data/pol212/03_figures/dag.png"))
```
...
knitr::include_graphics(here("data/pol212/03_figures/table1.png"))
```
...
```{r, echo=FALSE, out.width="70%", fig.align = 'center'}
knitr::include_graphics(here("data/pol212/03_figures/table2.png"))
```
